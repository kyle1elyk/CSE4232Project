...
class Decoder {
	...
	public String[] getStringsArray(byte type) throws ASN1DecoderFail{
		return getSequenceOfAL(type).toArray(new String[]{});
	}
	/**
	 * 
	...
	public Hashtable<String, String> getHSS(byte type, boolean alist) throws ASN1DecoderFail {
		return getSequenceOfHSS(type, alist);
	}	
	@Deprecated
	public ArrayList<String> getSequenceOfAL(byte type) throws ASN1DecoderFail{
		return getStringsAL(type);
	}
	public ArrayList<String> getStringsAL(byte type) throws ASN1DecoderFail{
	...
	public ArrayList<String> getSkipStringsAL(byte type) throws ASN1DecoderFail{
		return getStringsAL(type);
	}
	/**
	 * 
	...
	public ArrayList<BigInteger> getSequenceOfBNs(byte type) throws ASN1DecoderFail{
		return getBNsAL(type);
	}
	public ArrayList<BigInteger> getBNsAL(byte type) throws ASN1DecoderFail{
		if (getTypeByte() == Encoder.TAG_NULL) return null;
		Decoder dec = getContent();
	...
	public <T> ArrayList<T> getSkipSequenceOfAL(byte type, T inst) throws ASN1DecoderFail {
		return getSequenceOfAL(type, inst);
	}
	/**
	 * 
	 * @param <T>
	...
	public <T> T[] getSkipSequenceOf(byte type, T[] temp, T inst) throws ASN1DecoderFail {
		return getSequenceOf(type, temp, inst);
	}
	/**
	 * Skip over the first element if present.
	 * Returns NULL is no element present, otherwise returns "this" modified to skip
	 */
	public Decoder getFirstObjectSkip() {
	...
	public Decoder skipFirstObject() {
	...
	public boolean fetchAll(InputStream is) throws IOException {
		...
		while (true) {
			...
			if ((asrlen > 0) && (asrlen > data.length - offset)) {
				...
				return false; // not enough space (but tag already obtained)
			}
			if ((asrlen < 0) || (length < asrlen)) {
				if (DEBUG)System.out.println("Object size="+asrlen+"; Current size="+length);
				if (length == data.length - offset) return false; // at end of buffer (if not enough for the tag)
...
//		}
	...
	public boolean getSkipBoolean() {
		boolean result = getBoolean();
		skipFirstObject();
		return result;
	}
	public boolean getSkipBoolean(byte type) {
		boolean result = getSkipBoolean();
		skipFirstObject();
		return result;
	}
	public int getSkipIntValue() {
		int result = getIntValue();
		skipFirstObject();
		return result;
	}
	public BigInteger getSkipInteger() {
		BigInteger result = getInteger();
		skipFirstObject();
		return result;
	}
	public BigInteger getSkipInteger(byte tagInteger) throws ASN1DecoderFail {
	...
	public byte[] getSkipBytesAnyType() {
		byte[] result = getBytesAnyType();
		skipFirstObject();
		return result;
	}
	public byte[] getSkipBytes(byte type) throws ASN1DecoderFail {
		byte[] result = getBytes(type);
		skipFirstObject();
		return result;
	}
	public byte[] getSkipBitString_AnyType(byte[] bits_padding) {
		byte[] result = getBitString_AnyType(bits_padding);
		skipFirstObject();
		return result;
	}
	public int[] getSkipOID(byte type) throws ASN1DecoderFail {
		int[] result = getOID(type);
		skipFirstObject();
		return result;
	}
	public BigInteger[] getSkipBNOID(byte type) throws ASN1DecoderFail {
	...
	public String getSkipStringAnyType() throws ASN1DecoderFail {
		String result = getStringAnyType();
		skipFirstObject();
		return result;
	}
	public String getSkipString(byte type) throws ASN1DecoderFail {
		String result = getString(type);
		skipFirstObject();
		return result;
	}
	public String getSkipGeneralizedTimeAnyType() throws ASN1DecoderFail {
		String result = getGeneralizedTimeAnyType();
		skipFirstObject();
		return result;
	}
	public String getSkipGeneralizedTime(byte type) throws ASN1DecoderFail {
		String result = getGeneralizedTime(type);
		skipFirstObject();
		return result;
	}
	public String getSkipGeneralizedTime_() throws ASN1DecoderFail {
		String result = getGeneralizedTime_();
		skipFirstObject();
		return result;
	}
	public Calendar getSkipGeneralizedTimeCalender(byte type) throws ASN1DecoderFail {
		Calendar result = getGeneralizedTimeCalender(type);
		skipFirstObject();
		return result;
	}
	public Calendar getSkipGeneralizedTimeCalender_() throws ASN1DecoderFail {
		Calendar result = getGeneralizedTimeCalender_();
		skipFirstObject();
		return result;
	}
	public Calendar getSkipGeneralizedTimeCalenderAnyType() throws ASN1DecoderFail {
