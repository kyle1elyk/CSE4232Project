...
class Encoder {
	...
	*/
	...
	public Encoder initSequence(){
		header_type=new byte[]{buildASN1byteType(Encoder.CLASS_UNIVERSAL, Encoder.PC_CONSTRUCTED, Encoder.TAG_SEQUENCE)};
	...
	public static Encoder getEncoder(String[] param, byte type) {
		return getStringEncoder(param, type);
	}
	/**
	...
	public static Encoder getEncoder(ArrayList<String> param, byte type) {
		return getStringsEncoder(param, type);
	}
	/**
...
//		return enc;
	...
	public static Encoder getEncoder(int[] a) {
		return getEncoderArray(a);
	}
	/**
	...
	public static Encoder getEncoder(float[] a) {
		return getEncoderArray(a);
	}
}
